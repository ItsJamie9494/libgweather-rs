// Generated by gir (https://github.com/gtk-rs/gir @ c8286d7e5afd)
// from .. (@ ???)
...
pub const GWEATHER_PROVIDER_ALL: GWeatherProvider = 29;
...
impl ::std::fmt::Debug for GWeatherLocationClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GWeatherLocationClass @ {:p}", self))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
extern "C" {
    ...
    pub fn gweather_info_get_upcoming_moonphases(info: *mut GWeatherInfo, phases: *mut c_long) -> gboolean;
